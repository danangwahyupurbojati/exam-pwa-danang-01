            ...
            <div className="flex flex-col gap-2 tablet:gap-4">
                ...
                <div className="hidden tablet:flex desktop:flex flex-row gap-1 justify-between items-center w-full">
                    <Show when={showAddToCart && !viewItemOnly}>
                        <Button
                            ...
                            className={classNames(
                                ...
                                'hover:shadow-[0_0_0_4px] hover:shadow-primary-300 mx-auto',
                            )}
                        >
                    ...
                    <Show when={showWishlist || showProductCompare}>
                        <div
                            className="flex-row gap-1 hidden tablet:flex desktop:flex
                                absolute top-[-38px] justify-center w-full opacity-0
            ...
            <>
                ...
                <div
                    className={classNames(
                        ...
                        'desktop:hover:shadow-lg', 'group/product-item', 'product-tem',
